...
export default function TabOneScreen() {
  ...
  const selectItem = (item: any, setter: React.Dispatch<React.SetStateAction<any[]>>) => {
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {showPubs && pubs.map((pub, index) => (
          <View key={index} style={styles.pubContainer}>
            ...
            <TouchableOpacity onPress={() => selectItem(pub, setSelectedPubs)}>
        ...
        {showMovies && movies.map((movie, index) => (
          <View key={index} style={styles.pubContainer}>
            ...
            <TouchableOpacity onPress={() => selectItem(movie, setSelectedMovies)}>
              <Text style={styles.bookButton}>Book</Text>
            </TouchableOpacity>
          </View>
        ))}
        ...
        {showRestaurants && restaurants.map((restaurant, index) => (
          <View key={index} style={styles.pubContainer}>
            ...
            <TouchableOpacity onPress={() => selectItem(restaurant, setSelectedRestaurants)}>
              <Text style={styles.bookButton}>Book</Text>
            </TouchableOpacity>
          </View>
        ))}
        ...
        {showActivities && activities.map((activity, index) => (
          <View key={index} style={styles.pubContainer}>
            ...
            <TouchableOpacity onPress={() => selectItem(activity, setSelectedActivities)}>
              <Text style={styles.bookButton}>Book</Text>
            </TouchableOpacity>
          </View>
        ))}
